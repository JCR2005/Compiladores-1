...
public class TipeScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CORCH1", "CORCH2", "MAYOR_QUE", "MENOR_QUE", "DIFERENTE", "FINI_NSTRUCCION", 
			"DECIMAL", "ENTERO", "DOS_PUNTOS", "CADENA", "CARACTER", "MAIN", "HEADERS", 
			"PARRAFO", "BOTON", "ONCLICK", "INPUT", "IF", "ELSE", "VAR", "CONSOLE", 
			"LOG", "FUNCTION", "NUMBER", "STRING", "CHAR", "BOOLEAN", "VOID", "TRUE", 
			"FALSE", "IDENTIFICADOR", "WS"
		};
	}
